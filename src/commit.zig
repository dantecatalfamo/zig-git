...
pub fn restoreCommit(allocator: mem.Allocator, repo_path: []const u8, commit_object_name: [20]u8) !*Index {
    ...
    return try tree_zig.restoreTree(allocator, repo_path, commit.tree);
}
